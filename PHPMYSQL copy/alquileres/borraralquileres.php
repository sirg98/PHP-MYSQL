...
<body>
    ...
    <div class="main-content">
        ...
        $sql = "SELECT a.id_alquiler, u.nombre, c.marca, c.modelo, a.prestado, a.devuelto 
        FROM alquileres a, usuarios u, coches c
        ...
        if (mysqli_num_rows($result) > 0) 
        {
            ...
            echo "<table>";
            echo "<tr><th>Seleccionar</th><th>Nombre</th><th>Marca</th><th>Modelo</th><th>Prestado</th><th>Devuelto</th></tr>";
